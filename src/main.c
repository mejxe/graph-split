...
int main(int argc, char** argv){
    ...
    buffer_to_int_array(indexes_buffer,indexes,LINE_BUFFER_SIZE,&indexes_count);
    buffer_to_int_array(first_nodes_indexes_buffer,first_nodes_indexes,LINE_BUFFER_SIZE,&first_nodes_indexes_count);
    buffer_to_int_array(groups_buffer,groups,LINE_BUFFER_SIZE,&groups_count);
    buffer_to_int_array(first_group_indexes_buffer,first_group_indexes,LINE_BUFFER_SIZE,&first_group_indexes_count);
